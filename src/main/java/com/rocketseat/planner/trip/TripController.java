...
public class TripController {
    ...
    public ResponseEntity<TripCreateResponse> createTrip(@RequestBody TripRequestPayload payload){
        ...
        this.participantsService.registerParticipantesToEvent(payload.emails_to_invite(), newTrip);
    ...
    public ResponseEntity<ParticipantCreateResponse> inviteParticipant(@PathVariable UUID id, @RequestBody ParticipantRequestPayload payload){
        ...
        if(trip.isPresent()){
            ...
            if(rawTrip.getIsConfirmed()) this.participantsService.triggerConfirmationEmailToParticipants(payload.email());
    ...
    public ResponseEntity<List<ParticipantsData>> getAllParticipants(@PathVariable UUID id){
        List<ParticipantsData> participantsList = this.participantsService.getAllParticipantsFromEvent(id);
